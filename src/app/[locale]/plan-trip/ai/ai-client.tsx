...
export default function AiTripClient() {
  ...
  const isSelected = (id: string) =>
    items.some((i) => i.id.toString().includes(id));
      ...
      <section className="bg-card border border-border rounded-[2.5rem] p-4 md:p-6 shadow-2xl shadow-primary/5">
        <div className="flex flex-col lg:flex-row items-center gap-6">
          <div className="lg:border-r border-border/50 pr-6 hidden lg:block">
            <h3 className="font-display text-lg font-medium whitespace-nowrap">
              Refine Context
            </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 flex-1 w-full">
            <div className="space-y-1.5">
              <Label className="text-[9px] uppercase font-bold tracking-[0.2em] text-muted-foreground/60 ml-1">
                Destination
              </Label>
              <div className="relative">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setLocalInfo({ ...localInfo, destination: e.target.value })
                  }
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex items-center gap-2 bg-muted/20 border border-border/40 rounded-2xl px-3 h-12">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setLocalInfo({ ...localInfo, startDate: e.target.value })
                  }
                ...
                <input
                  ...
                  onChange={(e) =>
                    setLocalInfo({ ...localInfo, endDate: e.target.value })
                  }
                  className="bg-transparent border-none text-xs focus:ring-0 w-full p-0"
                />
              </div>
      ...
      <div className="w-full">
        <AnimatePresence mode="wait">
          {!isGenerated && !isLoading ? (
            ...
            >
              <div className="size-24 bg-surface-ink rounded-3xl shadow-xl shadow-primary-light/10 flex items-center justify-center mb-8 border border-primary/20">
                <RiSparkling2Line className="size-12 text-primary-light" />
              </div>
              <h3 className="text-3xl font-display font-medium mb-4">
                Crafting Local Excellence
              </h3>
              ...
              {object && (
                ...
                >
                  ...
                  <div className="max-w-4xl mx-auto text-center space-y-8">
                    <Badge
                      variant="outline"
                      className="uppercase tracking-[0.3em] text-[10px] py-1.5 px-4 border-primary/30 text-primary rounded-full"
                    >
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-8 text-xs font-bold uppercase tracking-widest text-muted-foreground/60 pt-4">
                      <span className="flex items-center gap-2 text-primary">
                        <RiMapPinLine className="size-4" /> {object.destination}
                      </span>
                      <span className="flex items-center gap-2">
                        <RiUser3Line className="size-4" /> {localInfo.travelers}{" "}
                        Adventurers
                      </span>
                      <span className="bg-primary/10 text-primary px-4 py-2 rounded-full border border-primary/10">
                        Total Est. $
                        {object.totalEstimatedBudget?.toLocaleString()}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="grid lg:grid-cols-12 gap-16">
                    <div className="lg:col-span-8 space-y-20">
                      ...
                      <div className="space-y-8">
                        <div className="flex items-center gap-4">
                          ...
                          <h3 className="font-display text-2xl font-medium flex items-center gap-3 px-4">
                            <RiHotelLine className="size-6 text-primary" />{" "}
                            Stays
                          </h3>
                          <div className="h-px flex-1 bg-border/50" />
                        </div>
                      ...
                      <div className="space-y-8">
                        <div className="flex items-center gap-4">
                          <div className="h-px flex-1 bg-border/50" />
                          <h3 className="font-display text-2xl font-medium flex items-center gap-3 px-4">
                            <RiUserStarLine className="size-6 text-primary" />{" "}
                            Experts
                          </h3>
                          <div className="h-px flex-1 bg-border/50" />
                        </div>
                    ...
                    <aside className="lg:col-span-4 sticky top-32">
                      <div className="bg-surface-ink text-primary-foreground border border-primary/10 rounded-[2.5rem] p-8 shadow-2xl space-y-8 relative overflow-hidden isolate">
                        ...
                        <div className="absolute top-0 right-0 p-4 opacity-10 pointer-events-none z-10 text-primary-light">
                        ...
                        <div className="relative z-20 space-y-6">
                          ...
                          <div className="space-y-4">
                            <div className="flex justify-between items-center py-3 border-b border-white/10">
                              <span className="text-xs font-bold uppercase tracking-widest text-primary-light/80">
                                Selections
                              </span>
                              <Badge
                                variant="secondary"
                          ...
                          <div className="pt-4 space-y-4">
                            <Button
                              ...
                              className="w-full rounded-2xl h-16 text-xs uppercase tracking-widest font-sans font-semibold bg-primary hover:bg-primary/90 text-white border-0 shadow-xl shadow-primary/20 transition-all duration-300 hover:scale-105"
                            >
                              Finalize Narrative
      ...
      <div className="space-y-4">
        <div className="flex justify-between items-start gap-4">
          <div className="min-w-0">
            <h4 className="font-display text-lg font-medium truncate leading-tight">
              {title}
            </h4>
        ...
        <p className="text-xs text-muted-foreground leading-relaxed line-clamp-3 italic">
          {description ||
            "A curated selection based on your specific travel profile and desired trip vibe."}
        </p>
      </div>
