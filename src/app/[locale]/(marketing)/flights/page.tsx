...
const EXTRA_FLIGHTS = [
  {
    ...
    departureTime: "2025-03-15T23:15:00",
    arrivalCity: "Kigali",
    arrivalAirport: "KGL",
    arrivalTime: "2025-03-16T06:35:00",
    duration: "7h 20m",
    stops: 0,
  ...
  },
  {
    ...
    arrivalCity: "Kigali",
    arrivalAirport: "KGL",
    arrivalTime: "2025-03-15T20:15:00",
    duration: "9h 45m",
    stops: 0,
  ...
  },
  {
    ...
    departureTime: "2025-03-15T21:00:00",
    arrivalCity: "Kigali",
    arrivalAirport: "KGL",
    arrivalTime: "2025-03-16T05:30:00",
    duration: "8h 30m",
    stops: 0,
    cabinClass: "economy" as const,
    price: 485,
  ...
  },
  {
    ...
    departureTime: "2025-03-15T22:30:00",
    arrivalCity: "Kigali",
    arrivalAirport: "KGL",
    arrivalTime: "2025-03-16T07:15:00",
    duration: "8h 45m",
    stops: 0,
    cabinClass: "economy" as const,
    price: 510,
...
const ALL_FLIGHTS = [...flights, ...EXTRA_FLIGHTS];
  ...
  const filteredFlights = useMemo(() => {
    ...
    if (from) {
      ...
      result = result.filter(
        (f) =>
          f.departureCity.toLowerCase().includes(fromSearch) ||
          f.departureAirport.toLowerCase().includes(fromSearch),
      );
    }
    ...
    if (classFilter !== "all") {
      result = result.filter((f) => f.cabinClass === classFilter);
    }
    ...
    return result;
  }, [from, maxPrice, stopsFilter, classFilter, sortBy]);
