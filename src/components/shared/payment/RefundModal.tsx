          ...
          {step === "confirm" && (
            <>
              <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 flex gap-3">
                <RiAlertLine className="size-5 text-amber-600 flex-shrink-0 mt-0.5" />
          ...
          {step === "success" && (
            <>
              <div className="bg-green-50 border border-green-200 rounded-lg p-4 flex gap-3">
                <RiCheckLine className="size-5 text-green-600 flex-shrink-0 mt-0.5" />
          ...
          {step === "error" && (
            <>
              <div className="bg-red-50 border border-red-200 rounded-lg p-4 flex gap-3">
                <RiAlertLine className="size-5 text-red-600 flex-shrink-0 mt-0.5" />
