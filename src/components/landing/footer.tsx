      ...
      <div className="mx-auto max-w-7xl px-5 md:px-10">
        <div className="grid md:grid-cols-12 gap-12 lg:gap-24 mb-24">
            ...
            <div className="flex items-center gap-2">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="size-10 flex items-center justify-center rounded-full border border-white/10 text-white/70 hover:bg-white hover:text-black hover:border-white transition-all duration-300 group"
                >
                  <social.icon
          ...
          <div className="md:col-span-8 lg:col-span-9 grid grid-cols-2 md:grid-cols-3 gap-12 lg:gap-20">
            <div>
              <h4 className="font-mono text-xs uppercase tracking-widest text-white/60 mb-8">
                {t("explore")}
              </h4>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex gap-8">
            <Link
              href="/privacy"
              className="text-xs text-white/30 hover:text-white uppercase tracking-wider transition-colors font-mono"
            >
              {t("privacy")}
            </Link>
            <Link
