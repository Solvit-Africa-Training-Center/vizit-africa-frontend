...
import { ValidationBadge } from "./ValidationAlertBanner";
                    ...
                    return (
                      <div key={item.tempId || item.id} className="relative">
                        {(itemValidation.errors > 0 ||
                          ...
                          <div className="absolute -left-4 top-0 bottom-0 w-1 rounded-r bg-linear-to-b from-yellow-500 to-yellow-400" />
                        )}
                        <ItineraryItem
                          item={item}
